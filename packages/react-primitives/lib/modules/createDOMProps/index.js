...
import css from "../../exports/Style/css";
import StyleSheet from "../../exports/StyleSheet";
import styleResolver from "../../exports/Style/styleResolver";
import { STYLE_GROUPS } from "../../exports/Style/constants";
...
const createDOMProps = (elementType, props) => {
  ...
  const disabled =
    (accessibilityState != null && accessibilityState.disabled === true) ||
    accessibilityDisabled;
  ...
  // Resolve styles
  const { className, style } = styleResolver.resolve(
    reactNativeStyle,
    finalClassList
  );
